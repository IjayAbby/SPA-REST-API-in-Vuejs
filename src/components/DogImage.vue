    ...
    <div class="flex flex-col h-[100vh] justify-center items-center">
        <div class="flex">
            ...
            <div class="ml-6 flex flex-col">
                ...
                <button class="w-[100px] h-[40px] flex justify-center items-center rounded-[10px] bg-black text-white"
                    @click="cartoonify_show">Cartoonify</button>
                <button class="w-[100px] my-4 h-[40px] flex justify-center items-center rounded-[10px] bg-black text-white"
                    @click="grayscale_show">Grayscale</button>
                <button class="w-[100px] h-[40px] flex justify-center items-center rounded-[10px] bg-black text-white"
                    @click="sepia_show">Sepia</button>
                <button class="w-[100px] my-4 h-[40px] flex justify-center items-center rounded-[10px] bg-black text-white"
                    @click="origin_show">Reset</button>
            </div>
        </div>
    </div>
</template>
